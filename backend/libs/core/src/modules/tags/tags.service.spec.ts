...
describe('TagsService', () => {
  ...
  describe('create', () => {
    it('should throw TagAlreadyExistsException if tag already exists', async () => {
      mockPrismaService.tag.findFirst.mockResolvedValueOnce({
        id: 1,
        name: 'test',
      });
    ...
    it('should create a tag if it does not exist', async () => {
      ...
      mockPrismaService.tag.create.mockResolvedValueOnce({
        id: 1,
        name: 'test',
      });
  ...
  describe('update', () => {
    ...
    it('should update the tag successfully', async () => {
      ...
      mockPrismaService.tag.update.mockResolvedValueOnce({
        id: 1,
        name: 'new',
      });
