...
describe(
  ...
  () => {
    ...
    it(
      'generic user update should reject role field',
      async () => {
        const {
          token,
        } =
    ...
    it(
      'admin password reset should revoke all active user sessions',
      async () => {
        const {
          token: adminToken,
        } =
    ...
    it(
      'switching default language should leave exactly one default',
      async () => {
        const {
          token,
        } =
    ...
    it(
      'should not allow unset, deactivate or delete current default language',
      async () => {
        const {
          token,
        } =
